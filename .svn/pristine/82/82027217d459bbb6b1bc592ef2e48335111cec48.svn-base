...
namespace CodeBase {
	public class ODMathLib {
		...
		///<summary>Returns the intersection of the given two rectangles as a set of 4 floats in the order (x,y,w,h), or returns an array of 0 floats if the two rectangles do not intersect.</summary>
