namespace OpenDental{
	partial class FormPerioGraphicalSetup {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			this.butColorProbingRed.Location=new System.Drawing.Point(323,78);
			...
			// label8
			// 
			this.label8.Location=new System.Drawing.Point(243,50);
			...
			this.butColorProbing.Location=new System.Drawing.Point(323,48);
			...
			this.butColorMGJ.Location=new System.Drawing.Point(323,20);
			...
			this.butColorGM.Location=new System.Drawing.Point(144,104);
			...
			// label10
			// 
			this.label10.Location=new System.Drawing.Point(43,78);
			...
			this.butColorFurcRed.Location=new System.Drawing.Point(144,76);
			...
			this.butColorFurc.Location=new System.Drawing.Point(144,48);
			...
			this.label5.Text="Clinical Attachment Level";
			...
			this.butColorCal.Location=new System.Drawing.Point(144,20);
			this.butColorCal.Name="butColorCal";
			this.butColorCal.Size=new System.Drawing.Size(22,22);
			this.butColorCal.TabIndex=219;
			...
			this.groupBox2.Controls.Add(this.butColorCal);
			this.groupBox2.Controls.Add(this.label7);
			this.groupBox2.Controls.Add(this.butColorFurc);
			this.groupBox2.Controls.Add(this.label9);
			this.groupBox2.Controls.Add(this.label10);
			this.groupBox2.Controls.Add(this.butColorProbingRed);
			this.groupBox2.Controls.Add(this.butColorFurcRed);
			this.groupBox2.Controls.Add(this.label8);
			this.groupBox2.Controls.Add(this.butColorGM);
			this.groupBox2.Controls.Add(this.butColorProbing);
			this.groupBox2.Controls.Add(this.label4);
			this.groupBox2.Controls.Add(this.label6);
			this.groupBox2.Controls.Add(this.butColorMGJ);
			this.groupBox2.Location=new System.Drawing.Point(12,12);
			this.groupBox2.Name="groupBox2";
			this.groupBox2.Size=new System.Drawing.Size(427,140);
			this.groupBox2.TabIndex=221;
			this.groupBox2.TabStop=false;
			this.groupBox2.Text="Setup Colors";
			// 
			// butOK
			// 
			...
			this.butOK.Location=new System.Drawing.Point(351,177);
			...
			this.butCancel.Location=new System.Drawing.Point(351,218);
			...
			this.Name="FormPerioGraphicalSetup";
			this.StartPosition=System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text="Graphical Perio Setup";
			this.Load+=new System.EventHandler(this.FormPerioGraphicalSetup_Load);
