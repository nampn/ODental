namespace OpenDental.User_Controls {
	partial class ContrKeyboard {
		...
		private void InitializeComponent() {
			...
			// butSpace
			// 
			this.butSpace.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.butSpace.Autosize = true;
			this.butSpace.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butSpace.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			...
			// button28
			// 
			this.button28.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.button28.Autosize = true;
			this.button28.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.button28.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			...
			// button30
			// 
			this.button30.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.button30.Autosize = true;
			this.button30.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.button30.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			...
			// button33
			// 
			this.button33.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.button33.Autosize = true;
			this.button33.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.button33.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			...
			// button34
			// 
			this.button34.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.button34.Autosize = true;
			this.button34.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.button34.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			...
			// button35
			// 
			this.button35.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.button35.Autosize = true;
			this.button35.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.button35.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			...
			// button36
			// 
			this.button36.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.button36.Autosize = true;
			this.button36.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.button36.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			...
			// button29
			// 
			this.button29.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.button29.Autosize = true;
			this.button29.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.button29.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			...
			// button31
			// 
			this.button31.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.button31.Autosize = true;
			this.button31.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.button31.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			...
			// button32
			// 
			this.button32.AdjustImageLocation = new System.Drawing.Point(0,0);
			this.button32.Autosize = true;
			this.button32.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.button32.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
